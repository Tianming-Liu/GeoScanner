...
class RecordingButton extends StatefulWidget {
  const RecordingButton({Key? key, required this.onToggle}) : super(key: key);

  final Function(bool isRecording, bool isPaused) onToggle;
...
class _RecordingButtonState extends State<RecordingButton> with SingleTickerProviderStateMixin {
  ...
  void _toggleRecording() {
    setState(() {
      ...
      widget.onToggle(_isRecording, _isRecordingPaused);
    });
  }
